...
public class FileUtil {
   ...
   public MultiPartParams fileUpload(HttpServletRequest request){
      ...
      try {
         ...
         paramMap.put("khs.files", fileDtoList); //요청파라미터값 검색할때, files는 다른 사용자들이 사용할 수 있는 파라미터이름.
         //다른사람의 files를 다른 목적의 파라미터로 사용하면 저걸 미리잡으면 충돌이나니까.
         //유니크한 파라미터명. 패키지명이 유니크.
